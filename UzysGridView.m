...
- (void)editableAnimation
{
    ...
    if(self.editable ==YES)
    {
        if([_cellInfo count] > 0)
        {
            ...
            [[NSUserDefaults standardUserDefaults]setObject:@"yes" forKey:@"touchcancled"];
            ...
            [UIControl animateWithDuration:0.6
                                ...
                                animations:^(void){
                                    ...
                                    for(int i=0;i<[_cellInfo count];i++)
                                    {
                                        ...
                                        //cell.ButtonDelete1.transform = CGAffineTransformMakeScale(1.1,1.1);
                                    }
...
//                                    [self editableAnimation];
    ...
    else
    {
        ...
        {            
            ...
            //cell.ButtonDelete1.transform = CGAffineTransformIdentity;
    ...
    if(self.editable)
    {
        ...
        if(MaxScrollwidth - cell.center.x < PAGEMOVEMARGIN)
        {
            if(_movePagesTimer == nil)
            {
                ...
                NSLog(@"checking position is %f", cell.layer.frame.origin.x);
                
                if (cell.layer.frame.origin.x > 230) {
                    
                    NSLog(@"go to next pageeeeee");
                    
                    [customdelegate gotoNextPageByDragging];
